...
hs_res hs_open(char *name, char **cfg, size_t num_cfg);
...
// executes an update on rows identified by keys and narrowed down by filters, using given vals
hs_res hs_filtered_update(char *name, char **keys, size_t num_keys, char **filters, size_t num_filters, char **vals, size_t num_vals);

// executes an update on the hs handle with the given name
hs_res hs_update(char *name, char **keys, size_t num_keys, char **vals, size_t num_vals);

// executes a delete on rows identified by keys and narrowed down by filters
hs_res hs_filtered_delete(char *name, char **keys, size_t num_keys, char **filters, size_t num_filters);

// executes a delete on rows identified by keys
hs_res hs_delete(char *name, char **keys, size_t num_keys);
