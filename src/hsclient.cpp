...
hs_result* hs_connect(hs_connection **con, char **cfg, size_t num_cfg) {
    dena::config conf;
    ...
    *con = hs_create_connection();
    ...
    do {
        ...
        cli->request_buf_open_index((*con)->index, dbname.c_str(), table.c_str(),
